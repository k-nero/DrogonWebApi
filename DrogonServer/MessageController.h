...
public:
	static void initPathRouting()
	{
		...
		registerMethod(&MessageController::GetPaginated, "/api/message?chat_id={1}&page={2}&limit={3}", { drogon::HttpMethod::Get }, false, "MessageController::GetAll");
	...
	void GetPaginated(const HttpRequestPtr& req, std::function<void(const HttpResponsePtr&)>&& callback, std::string chat_id, int page, int limit );
};
