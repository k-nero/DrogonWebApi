...
typedef sqlite3_int64 (*sqlite3_changes64_t)(sqlite3*);
...
typedef int(*sqlite3_prepare_v3_t)(
	sqlite3* db,            /* Database handle */
	const void* zSql,       /* SQL statement, UTF-16 encoded */
	int nByte,              /* Maximum length of zSql in bytes. */
...
typedef int(*sqlite3_config_t)(int, ...);
typedef int(*sqlite3_initialize_t)(void);
typedef int(*sqlite3_shutdown_t)(void);

// API declarations
class SQLAPI_API sl3API : public IsaAPI
{
public:
	sl3API();
...
public:
	...
	sqlite3_config_t sqlite3_config;
	sqlite3_initialize_t sqlite3_initialize;
	sqlite3_shutdown_t sqlite3_shutdown;

	sqlite3_changes64_t sqlite3_changes64;
...
#define SACON_OPTION_SQLITE_SKIP_INIT _TSA("SQLiteSkipInitialization")
